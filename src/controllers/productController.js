...
//         // Each variant type has: id, type, variants array
...
//               // Calculate sub-variant cost per item
...
//       .select('productName slug regularPrice discountPrice images rating stockQuantity unit tags brand category subcategory childSubcategory createdAt fullDescription shortDescription hasVariants variantTypes addOnes')
//       .populate({
//         path: 'category',
//         select: 'name slug'
//       })
...
//       .populate('category', 'name slug')
//       .populate('tags', 'name image')
//       .select('productName slug regularPrice discountPrice images rating stockQuantity tags category categoryName subcategoryName childSubcategoryName brand unit hasVariants variantTypes');
...
//     // ============================================
// // ============================================================
// // PROCESS VARIANTS - NEW (in updateProduct)
// // =============================================
...
//     // COST PER ITEM IS AUTO-CALCULATED
...
//     // If product has a barcode, update barcode status
//     if (product.barcode) {
//       const Barcode = mongoose.model('Barcode');
...
//     })
//       .limit(parseInt(limit))
//       .select('productName slug regularPrice discountPrice images rating unit tags hasVariants variantTypes addOnes');
...
//       .populate('category', 'name slug')
//       .limit(parseInt(limit))
//       .select('productName slug regularPrice discountPrice images rating stockQuantity category unit tags hasVariants variantTypes addOnes');
...
//       .limit(parseInt(limit))
//       .select('productName slug regularPrice discountPrice images rating purchaseCount unit tags hasVariants variantTypes addOnes');
